...
```{r}
test_full <- test_full %>% mutate(province = fct_recode(province, "Manitoba" = "Maintoba", "Nova Scotia" = "Nova Scoita")) %>% mutate_if(is.factor, as.character)
test_reduced <- test_reduced %>% mutate(province = fct_recode(province, "Manitoba" = "Maintoba" , "Nova Scotia" = "Nova Scoita")) %>% mutate_if(is.factor, as.character)
